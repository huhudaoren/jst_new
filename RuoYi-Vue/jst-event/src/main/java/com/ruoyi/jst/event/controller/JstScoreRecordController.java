 ...
 */
@RestController
@RequestMapping("/jst/event/jst_score_record")
public class JstScoreRecordController extends BaseController
{
     ...
     * 导出成绩记录列表
     */
    @PreAuthorize("@ss.hasPermi('jst:event:score_record:export')")
     ...
     * 获取成绩记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:event:score_record:query')")
     ...
     * 删除成绩记录
     */
    @PreAuthorize("@ss.hasPermi('jst:event:score_record:remove')")
