...
import com.ruoyi.jst.event.service.IJstCourseLearnRecordService;
 ...
 */
@RestController
@RequestMapping("/jst/event/jst_course_learn_record")
public class JstCourseLearnRecordController extends BaseController
{
     ...
     * 查询课程学习记录列表
     */
    @PreAuthorize("@ss.hasPermi('jst:event:course_learn_record:list')")
    @GetMapping("/list")
     ...
     * 导出课程学习记录列表
     */
    @PreAuthorize("@ss.hasPermi('jst:event:course_learn_record:export')")
     ...
     * 获取课程学习记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:event:course_learn_record:query')")
     ...
     * 新增课程学习记录
     */
    @PreAuthorize("@ss.hasPermi('jst:event:course_learn_record:add')")
     ...
     * 修改课程学习记录
     */
    @PreAuthorize("@ss.hasPermi('jst:event:course_learn_record:edit')")
     ...
     * 删除课程学习记录
     */
    @PreAuthorize("@ss.hasPermi('jst:event:course_learn_record:remove')")
