...
import com.ruoyi.jst.event.service.IJstCourseService;
 ...
 */
@RestController
@RequestMapping("/jst/event/jst_course")
public class JstCourseController extends BaseController
{
     ...
     * 导出课程列表
     */
    @PreAuthorize("@ss.hasPermi('jst:event:course:export')")
     ...
     * 删除课程
     */
    @PreAuthorize("@ss.hasPermi('jst:event:course:remove')")
