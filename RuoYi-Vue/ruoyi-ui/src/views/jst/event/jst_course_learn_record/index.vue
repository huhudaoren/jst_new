...
<script>
import { listJst_course_learn_record, getJst_course_learn_record, delJst_course_learn_record, addJst_course_learn_record, updateJst_course_learn_record } from "@/api/jst/event/jst_course_learn_record"
