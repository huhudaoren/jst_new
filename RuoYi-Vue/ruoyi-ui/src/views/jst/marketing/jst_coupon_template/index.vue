...
<script>
import { listJst_coupon_template, getJst_coupon_template, delJst_coupon_template, addJst_coupon_template, updateJst_coupon_template } from "@/api/jst/marketing/jst_coupon_template"
