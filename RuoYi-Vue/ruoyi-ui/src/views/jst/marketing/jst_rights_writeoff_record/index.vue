...
<script>
import { listJst_rights_writeoff_record, getJst_rights_writeoff_record, delJst_rights_writeoff_record, addJst_rights_writeoff_record, updateJst_rights_writeoff_record } from "@/api/jst/marketing/jst_rights_writeoff_record"
