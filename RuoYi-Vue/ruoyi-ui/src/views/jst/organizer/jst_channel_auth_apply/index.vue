...
<script>
import { listJst_channel_auth_apply, getJst_channel_auth_apply, delJst_channel_auth_apply, addJst_channel_auth_apply, updateJst_channel_auth_apply } from "@/api/jst/organizer/jst_channel_auth_apply"
