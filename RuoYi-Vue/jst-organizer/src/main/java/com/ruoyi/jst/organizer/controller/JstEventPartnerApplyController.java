 ...
 */
@RestController
@RequestMapping("/jst/organizer/jst_event_partner_apply")
public class JstEventPartnerApplyController extends BaseController
{
     ...
     * 查询赛事方入驻申请列表
     */
    @PreAuthorize("@ss.hasPermi('jst:organizer:event_partner_apply:list')")
    @GetMapping("/list")
     ...
     * 导出赛事方入驻申请列表
     */
    @PreAuthorize("@ss.hasPermi('jst:organizer:event_partner_apply:export')")
     ...
     * 获取赛事方入驻申请详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:organizer:event_partner_apply:query')")
     ...
     * 新增赛事方入驻申请
     */
    @PreAuthorize("@ss.hasPermi('jst:organizer:event_partner_apply:add')")
     ...
     * 修改赛事方入驻申请
     */
    @PreAuthorize("@ss.hasPermi('jst:organizer:event_partner_apply:edit')")
     ...
     * 删除赛事方入驻申请
     */
    @PreAuthorize("@ss.hasPermi('jst:organizer:event_partner_apply:remove')")
