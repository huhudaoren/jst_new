...
import com.ruoyi.jst.risk.domain.JstRiskRule;
import com.ruoyi.jst.risk.service.IJstRiskRuleService;
 ...
 */
@RestController
@RequestMapping("/jst/risk/jst_risk_rule")
public class JstRiskRuleController extends BaseController
{
     ...
     * 查询风控规则列表
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_rule:list')")
    @GetMapping("/list")
     ...
     * 导出风控规则列表
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_rule:export')")
     ...
     * 获取风控规则详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_rule:query')")
     ...
     * 新增风控规则
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_rule:add')")
     ...
     * 修改风控规则
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_rule:edit')")
     ...
     * 删除风控规则
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_rule:remove')")
