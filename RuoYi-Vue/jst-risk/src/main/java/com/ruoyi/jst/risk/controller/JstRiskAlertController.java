...
import com.ruoyi.jst.risk.service.IJstRiskAlertService;
 ...
 */
@RestController
@RequestMapping("/jst/risk/jst_risk_alert")
public class JstRiskAlertController extends BaseController
{
     ...
     * 查询风险预警列表
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_alert:list')")
    @GetMapping("/list")
     ...
     * 导出风险预警列表
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_alert:export')")
     ...
     * 获取风险预警详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_alert:query')")
     ...
     * 新增风险预警
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_alert:add')")
     ...
     * 修改风险预警
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_alert:edit')")
     ...
     * 删除风险预警
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:risk_alert:remove')")
