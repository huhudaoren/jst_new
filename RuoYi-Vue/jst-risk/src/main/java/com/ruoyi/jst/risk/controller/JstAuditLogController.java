...
import com.ruoyi.jst.risk.service.IJstAuditLogService;
 ...
 */
@RestController
@RequestMapping("/jst/risk/jst_audit_log")
public class JstAuditLogController extends BaseController
{
     ...
     * 查询操作审计日志列表
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:audit_log:list')")
    @GetMapping("/list")
     ...
     * 导出操作审计日志列表
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:audit_log:export')")
     ...
     * 获取操作审计日志详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:audit_log:query')")
     ...
     * 新增操作审计日志
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:audit_log:add')")
     ...
     * 修改操作审计日志
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:audit_log:edit')")
     ...
     * 删除操作审计日志
     */
    @PreAuthorize("@ss.hasPermi('jst:risk:audit_log:remove')")
