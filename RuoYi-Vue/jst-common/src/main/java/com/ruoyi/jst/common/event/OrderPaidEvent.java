...
public class OrderPaidEvent extends ApplicationEvent {
     ...
     * @param source    事件源
     * @param userId    用户ID
     * @param bizId     业务ID（order_id）
     * @param bizType   业务类型（order_paid）
     * @param extraData 扩展数据
     */
    public OrderPaidEvent(Object source, Long userId, Long bizId, String bizType, Map<String, Object> extraData) {
        super(source);
        this.userId = userId;
        this.bizId = bizId;
