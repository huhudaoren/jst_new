...
public class RefundSuccessEvent extends ApplicationEvent {
     ...
     * @param source    事件源
     * @param userId    用户ID
     * @param bizId     业务ID（refund_id）
     * @param bizType   业务类型（refund_success）
     * @param extraData 扩展数据
     */
    public RefundSuccessEvent(Object source, Long userId, Long bizId, String bizType, Map<String, Object> extraData) {
        super(source);
        this.userId = userId;
        this.bizId = bizId;
