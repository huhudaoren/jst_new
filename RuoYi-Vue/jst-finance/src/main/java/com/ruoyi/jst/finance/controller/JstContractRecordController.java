 ...
 */
@RestController
@RequestMapping("/jst/finance/jst_contract_record")
public class JstContractRecordController extends BaseController
{
     ...
     * 查询合同记录列表
     */
    @PreAuthorize("@ss.hasPermi('jst:finance:contract_record:list')")
    @GetMapping("/list")
     ...
     * 导出合同记录列表
     */
    @PreAuthorize("@ss.hasPermi('jst:finance:contract_record:export')")
     ...
     * 获取合同记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:finance:contract_record:query')")
     ...
     * 新增合同记录
     */
    @PreAuthorize("@ss.hasPermi('jst:finance:contract_record:add')")
     ...
     * 修改合同记录
     */
    @PreAuthorize("@ss.hasPermi('jst:finance:contract_record:edit')")
     ...
     * 删除合同记录
     */
    @PreAuthorize("@ss.hasPermi('jst:finance:contract_record:remove')")
