 ...
 */
@RestController
@RequestMapping("/system/jst_enroll_record")
public class JstEnrollRecordController extends BaseController
{
     ...
     * 查询报名记录（含动态单快照）列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_record:list')")
    @GetMapping("/list")
     ...
     * 导出报名记录（含动态单快照）列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_record:export')")
     ...
     * 获取报名记录（含动态单快照）详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_record:query')")
     ...
     * 新增报名记录（含动态单快照）
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_record:add')")
     ...
     * 修改报名记录（含动态单快照）
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_record:edit')")
     ...
     * 删除报名记录（含动态单快照）
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_record:remove')")
