...
import com.ruoyi.system.service.IJstCertRecordService;
 ...
 */
@RestController
@RequestMapping("/system/jst_cert_record")
public class JstCertRecordController extends BaseController
{
     ...
     * 查询证书记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_cert_record:list')")
    @GetMapping("/list")
     ...
     * 导出证书记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_cert_record:export')")
     ...
     * 获取证书记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_cert_record:query')")
     ...
     * 新增证书记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_cert_record:add')")
     ...
     * 修改证书记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_cert_record:edit')")
     ...
     * 删除证书记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_cert_record:remove')")
