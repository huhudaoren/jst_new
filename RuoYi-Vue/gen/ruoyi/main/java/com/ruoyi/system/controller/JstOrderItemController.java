 ...
 */
@RestController
@RequestMapping("/system/jst_order_item")
public class JstOrderItemController extends BaseController
{
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_order_item:list')")
    @GetMapping("/list")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_order_item:export')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_order_item:query')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_order_item:add')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_order_item:edit')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_order_item:remove')")
