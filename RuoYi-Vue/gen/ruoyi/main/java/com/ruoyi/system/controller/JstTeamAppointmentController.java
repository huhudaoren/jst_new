...
import com.ruoyi.system.service.IJstTeamAppointmentService;
 ...
 */
@RestController
@RequestMapping("/system/jst_team_appointment")
public class JstTeamAppointmentController extends BaseController
{
     ...
     * 查询团队预约主记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_team_appointment:list')")
    @GetMapping("/list")
     ...
     * 导出团队预约主记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_team_appointment:export')")
     ...
     * 获取团队预约主记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_team_appointment:query')")
     ...
     * 新增团队预约主记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_team_appointment:add')")
     ...
     * 修改团队预约主记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_team_appointment:edit')")
     ...
     * 删除团队预约主记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_team_appointment:remove')")
