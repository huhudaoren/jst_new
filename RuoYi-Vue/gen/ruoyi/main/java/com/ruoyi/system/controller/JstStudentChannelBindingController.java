...
import com.ruoyi.system.service.IJstStudentChannelBindingService;
 ...
 */
@RestController
@RequestMapping("/system/jst_student_channel_binding")
public class JstStudentChannelBindingController extends BaseController
{
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_student_channel_binding:list')")
    @GetMapping("/list")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_student_channel_binding:export')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_student_channel_binding:query')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_student_channel_binding:add')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_student_channel_binding:edit')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_student_channel_binding:remove')")
