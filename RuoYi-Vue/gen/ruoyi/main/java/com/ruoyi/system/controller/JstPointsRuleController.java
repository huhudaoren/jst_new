...
import com.ruoyi.system.service.IJstPointsRuleService;
 ...
 */
@RestController
@RequestMapping("/system/jst_points_rule")
public class JstPointsRuleController extends BaseController
{
     ...
     * 查询积分/成长值规则列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_rule:list')")
    @GetMapping("/list")
     ...
     * 导出积分/成长值规则列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_rule:export')")
     ...
     * 获取积分/成长值规则详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_rule:query')")
     ...
     * 新增积分/成长值规则
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_rule:add')")
     ...
     * 修改积分/成长值规则
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_rule:edit')")
     ...
     * 删除积分/成长值规则
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_rule:remove')")
