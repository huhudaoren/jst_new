...
import com.ruoyi.system.service.IJstChannelAuthApplyService;
 ...
 */
@RestController
@RequestMapping("/system/jst_channel_auth_apply")
public class JstChannelAuthApplyController extends BaseController
{
     ...
     * 查询渠道认证申请列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_channel_auth_apply:list')")
    @GetMapping("/list")
     ...
     * 导出渠道认证申请列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_channel_auth_apply:export')")
     ...
     * 获取渠道认证申请详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_channel_auth_apply:query')")
     ...
     * 新增渠道认证申请
     */
    @PreAuthorize("@ss.hasPermi('system:jst_channel_auth_apply:add')")
     ...
     * 修改渠道认证申请
     */
    @PreAuthorize("@ss.hasPermi('system:jst_channel_auth_apply:edit')")
     ...
     * 删除渠道认证申请
     */
    @PreAuthorize("@ss.hasPermi('system:jst_channel_auth_apply:remove')")
