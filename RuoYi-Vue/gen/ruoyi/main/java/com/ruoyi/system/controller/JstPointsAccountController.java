...
import com.ruoyi.system.service.IJstPointsAccountService;
 ...
 */
@RestController
@RequestMapping("/system/jst_points_account")
public class JstPointsAccountController extends BaseController
{
     ...
     * 查询积分账户列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_account:list')")
    @GetMapping("/list")
     ...
     * 导出积分账户列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_account:export')")
     ...
     * 获取积分账户详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_account:query')")
     ...
     * 新增积分账户
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_account:add')")
     ...
     * 修改积分账户
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_account:edit')")
     ...
     * 删除积分账户
     */
    @PreAuthorize("@ss.hasPermi('system:jst_points_account:remove')")
