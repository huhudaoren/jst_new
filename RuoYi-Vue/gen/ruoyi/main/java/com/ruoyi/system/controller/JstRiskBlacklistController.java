 ...
 */
@RestController
@RequestMapping("/system/jst_risk_blacklist")
public class JstRiskBlacklistController extends BaseController
{
     ...
     * 查询风控黑白名单列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_blacklist:list')")
    @GetMapping("/list")
     ...
     * 导出风控黑白名单列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_blacklist:export')")
     ...
     * 获取风控黑白名单详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_blacklist:query')")
     ...
     * 新增风控黑白名单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_blacklist:add')")
     ...
     * 修改风控黑白名单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_blacklist:edit')")
     ...
     * 删除风控黑白名单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_blacklist:remove')")
