...
import com.ruoyi.system.domain.JstRiskCase;
import com.ruoyi.system.service.IJstRiskCaseService;
 ...
 */
@RestController
@RequestMapping("/system/jst_risk_case")
public class JstRiskCaseController extends BaseController
{
     ...
     * 查询风险工单列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_case:list')")
    @GetMapping("/list")
     ...
     * 导出风险工单列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_case:export')")
     ...
     * 获取风险工单详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_case:query')")
     ...
     * 新增风险工单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_case:add')")
     ...
     * 修改风险工单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_case:edit')")
     ...
     * 删除风险工单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_risk_case:remove')")
