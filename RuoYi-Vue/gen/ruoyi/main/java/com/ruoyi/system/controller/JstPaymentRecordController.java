...
import com.ruoyi.system.service.IJstPaymentRecordService;
 ...
 */
@RestController
@RequestMapping("/system/jst_payment_record")
public class JstPaymentRecordController extends BaseController
{
     ...
     * 查询支付记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_record:list')")
    @GetMapping("/list")
     ...
     * 导出支付记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_record:export')")
     ...
     * 获取支付记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_record:query')")
     ...
     * 新增支付记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_record:add')")
     ...
     * 修改支付记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_record:edit')")
     ...
     * 删除支付记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_record:remove')")
