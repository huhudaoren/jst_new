...
import com.ruoyi.system.service.IJstEventPartnerService;
 ...
 */
@RestController
@RequestMapping("/system/jst_event_partner")
public class JstEventPartnerController extends BaseController
{
     ...
     * 查询赛事方档案列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_event_partner:list')")
    @GetMapping("/list")
     ...
     * 导出赛事方档案列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_event_partner:export')")
     ...
     * 获取赛事方档案详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_event_partner:query')")
     ...
     * 新增赛事方档案
     */
    @PreAuthorize("@ss.hasPermi('system:jst_event_partner:add')")
     ...
     * 修改赛事方档案
     */
    @PreAuthorize("@ss.hasPermi('system:jst_event_partner:edit')")
     ...
     * 删除赛事方档案
     */
    @PreAuthorize("@ss.hasPermi('system:jst_event_partner:remove')")
