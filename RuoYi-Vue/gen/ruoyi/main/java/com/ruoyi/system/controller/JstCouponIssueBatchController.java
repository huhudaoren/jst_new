...
import com.ruoyi.system.service.IJstCouponIssueBatchService;
 ...
 */
@RestController
@RequestMapping("/system/jst_coupon_issue_batch")
public class JstCouponIssueBatchController extends BaseController
{
     ...
     * 查询发券批次列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_coupon_issue_batch:list')")
    @GetMapping("/list")
     ...
     * 导出发券批次列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_coupon_issue_batch:export')")
     ...
     * 获取发券批次详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_coupon_issue_batch:query')")
     ...
     * 新增发券批次
     */
    @PreAuthorize("@ss.hasPermi('system:jst_coupon_issue_batch:add')")
     ...
     * 修改发券批次
     */
    @PreAuthorize("@ss.hasPermi('system:jst_coupon_issue_batch:edit')")
     ...
     * 删除发券批次
     */
    @PreAuthorize("@ss.hasPermi('system:jst_coupon_issue_batch:remove')")
