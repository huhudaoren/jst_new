 ...
 */
@RestController
@RequestMapping("/system/jst_mall_exchange_order")
public class JstMallExchangeOrderController extends BaseController
{
     ...
     * 查询积分商城兑换订单列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_mall_exchange_order:list')")
    @GetMapping("/list")
     ...
     * 导出积分商城兑换订单列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_mall_exchange_order:export')")
     ...
     * 获取积分商城兑换订单详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_mall_exchange_order:query')")
     ...
     * 新增积分商城兑换订单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_mall_exchange_order:add')")
     ...
     * 修改积分商城兑换订单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_mall_exchange_order:edit')")
     ...
     * 删除积分商城兑换订单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_mall_exchange_order:remove')")
