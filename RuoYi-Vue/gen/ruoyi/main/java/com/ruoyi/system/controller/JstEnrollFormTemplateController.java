...
import com.ruoyi.system.service.IJstEnrollFormTemplateService;
 ...
 */
@RestController
@RequestMapping("/system/jst_enroll_form_template")
public class JstEnrollFormTemplateController extends BaseController
{
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_form_template:list')")
    @GetMapping("/list")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_form_template:export')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_form_template:query')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_form_template:add')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_form_template:edit')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:jst_enroll_form_template:remove')")
