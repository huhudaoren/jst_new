...
import com.ruoyi.system.service.IJstPaymentPayRecordService;
 ...
 */
@RestController
@RequestMapping("/system/jst_payment_pay_record")
public class JstPaymentPayRecordController extends BaseController
{
     ...
     * 查询统一打款记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_pay_record:list')")
    @GetMapping("/list")
     ...
     * 导出统一打款记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_pay_record:export')")
     ...
     * 获取统一打款记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_pay_record:query')")
     ...
     * 新增统一打款记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_pay_record:add')")
     ...
     * 修改统一打款记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_pay_record:edit')")
     ...
     * 删除统一打款记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_payment_pay_record:remove')")
