...
import com.ruoyi.system.domain.JstInvoiceRecord;
import com.ruoyi.system.service.IJstInvoiceRecordService;
 ...
 */
@RestController
@RequestMapping("/system/jst_invoice_record")
public class JstInvoiceRecordController extends BaseController
{
     ...
     * 查询发票记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_invoice_record:list')")
    @GetMapping("/list")
     ...
     * 导出发票记录列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_invoice_record:export')")
     ...
     * 获取发票记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_invoice_record:query')")
     ...
     * 新增发票记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_invoice_record:add')")
     ...
     * 修改发票记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_invoice_record:edit')")
     ...
     * 删除发票记录
     */
    @PreAuthorize("@ss.hasPermi('system:jst_invoice_record:remove')")
