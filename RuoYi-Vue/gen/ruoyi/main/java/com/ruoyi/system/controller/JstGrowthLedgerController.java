...
import com.ruoyi.system.domain.JstGrowthLedger;
import com.ruoyi.system.service.IJstGrowthLedgerService;
 ...
 */
@RestController
@RequestMapping("/system/jst_growth_ledger")
public class JstGrowthLedgerController extends BaseController
{
     ...
     * 查询成长值流水列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_growth_ledger:list')")
    @GetMapping("/list")
     ...
     * 导出成长值流水列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_growth_ledger:export')")
     ...
     * 获取成长值流水详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_growth_ledger:query')")
     ...
     * 新增成长值流水
     */
    @PreAuthorize("@ss.hasPermi('system:jst_growth_ledger:add')")
     ...
     * 修改成长值流水
     */
    @PreAuthorize("@ss.hasPermi('system:jst_growth_ledger:edit')")
     ...
     * 删除成长值流水
     */
    @PreAuthorize("@ss.hasPermi('system:jst_growth_ledger:remove')")
