 ...
 */
@RestController
@RequestMapping("/system/jst_user_coupon")
public class JstUserCouponController extends BaseController
{
     ...
     * 查询用户持有优惠券列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_user_coupon:list')")
    @GetMapping("/list")
     ...
     * 导出用户持有优惠券列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_user_coupon:export')")
     ...
     * 获取用户持有优惠券详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_user_coupon:query')")
     ...
     * 新增用户持有优惠券
     */
    @PreAuthorize("@ss.hasPermi('system:jst_user_coupon:add')")
     ...
     * 修改用户持有优惠券
     */
    @PreAuthorize("@ss.hasPermi('system:jst_user_coupon:edit')")
     ...
     * 删除用户持有优惠券
     */
    @PreAuthorize("@ss.hasPermi('system:jst_user_coupon:remove')")
