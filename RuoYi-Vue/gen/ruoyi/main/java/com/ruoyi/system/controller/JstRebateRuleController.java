 ...
 */
@RestController
@RequestMapping("/system/jst_rebate_rule")
public class JstRebateRuleController extends BaseController
{
     ...
     * 查询渠道返点规则列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_rule:list')")
    @GetMapping("/list")
     ...
     * 导出渠道返点规则列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_rule:export')")
     ...
     * 获取渠道返点规则详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_rule:query')")
     ...
     * 新增渠道返点规则
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_rule:add')")
     ...
     * 修改渠道返点规则
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_rule:edit')")
     ...
     * 删除渠道返点规则
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_rule:remove')")
