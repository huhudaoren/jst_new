 ...
 */
@RestController
@RequestMapping("/system/jst_contest")
public class JstContestController extends BaseController
{
     ...
     * 查询赛事主列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_contest:list')")
    @GetMapping("/list")
     ...
     * 导出赛事主列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_contest:export')")
     ...
     * 获取赛事主详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_contest:query')")
     ...
     * 新增赛事主
     */
    @PreAuthorize("@ss.hasPermi('system:jst_contest:add')")
     ...
     * 修改赛事主
     */
    @PreAuthorize("@ss.hasPermi('system:jst_contest:edit')")
     ...
     * 删除赛事主
     */
    @PreAuthorize("@ss.hasPermi('system:jst_contest:remove')")
