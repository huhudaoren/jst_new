 ...
 */
@RestController
@RequestMapping("/system/jst_rebate_settlement")
public class JstRebateSettlementController extends BaseController
{
     ...
     * 查询渠道提现/结算单列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_settlement:list')")
    @GetMapping("/list")
     ...
     * 导出渠道提现/结算单列表
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_settlement:export')")
     ...
     * 获取渠道提现/结算单详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_settlement:query')")
     ...
     * 新增渠道提现/结算单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_settlement:add')")
     ...
     * 修改渠道提现/结算单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_settlement:edit')")
     ...
     * 删除渠道提现/结算单
     */
    @PreAuthorize("@ss.hasPermi('system:jst_rebate_settlement:remove')")
