 ...
 */
@RestController
@RequestMapping("/jst/marketing/jst_rights_template")
public class JstRightsTemplateController extends BaseController
{
     ...
     * 查询权益模板列表
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_template:list')")
    @GetMapping("/list")
     ...
     * 导出权益模板列表
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_template:export')")
     ...
     * 获取权益模板详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_template:query')")
     ...
     * 新增权益模板
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_template:add')")
     ...
     * 修改权益模板
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_template:edit')")
     ...
     * 删除权益模板
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_template:remove')")
