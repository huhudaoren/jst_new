 ...
 */
@RestController
@RequestMapping("/jst/marketing/jst_coupon_template")
public class JstCouponTemplateController extends BaseController
{
     ...
     * 查询优惠券模板列表
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:coupon_template:list')")
    @GetMapping("/list")
     ...
     * 导出优惠券模板列表
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:coupon_template:export')")
     ...
     * 获取优惠券模板详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:coupon_template:query')")
     ...
     * 新增优惠券模板
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:coupon_template:add')")
     ...
     * 修改优惠券模板
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:coupon_template:edit')")
     ...
     * 删除优惠券模板
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:coupon_template:remove')")
