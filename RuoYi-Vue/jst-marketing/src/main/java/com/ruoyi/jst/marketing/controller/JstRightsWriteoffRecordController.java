 ...
 */
@RestController
@RequestMapping("/jst/marketing/jst_rights_writeoff_record")
public class JstRightsWriteoffRecordController extends BaseController
{
     ...
     * 查询权益核销记录列表
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_writeoff_record:list')")
    @GetMapping("/list")
     ...
     * 导出权益核销记录列表
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_writeoff_record:export')")
     ...
     * 获取权益核销记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_writeoff_record:query')")
     ...
     * 新增权益核销记录
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_writeoff_record:add')")
     ...
     * 修改权益核销记录
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_writeoff_record:edit')")
     ...
     * 删除权益核销记录
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:rights_writeoff_record:remove')")
