...
import com.ruoyi.jst.marketing.service.IJstUserRightsService;
 ...
 */
@RestController
@RequestMapping("/jst/marketing/jst_user_rights")
public class JstUserRightsController extends BaseController
{
     ...
     * 查询用户权益持有列表
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:user_rights:list')")
    @GetMapping("/list")
     ...
     * 导出用户权益持有列表
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:user_rights:export')")
     ...
     * 获取用户权益持有详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:user_rights:query')")
     ...
     * 新增用户权益持有
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:user_rights:add')")
     ...
     * 修改用户权益持有
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:user_rights:edit')")
     ...
     * 删除用户权益持有
     */
    @PreAuthorize("@ss.hasPermi('jst:marketing:user_rights:remove')")
