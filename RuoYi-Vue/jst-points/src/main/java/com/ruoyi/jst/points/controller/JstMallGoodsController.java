...
import com.ruoyi.jst.points.service.IJstMallGoodsService;
 ...
 */
@RestController
@RequestMapping("/jst/points/jst_mall_goods")
public class JstMallGoodsController extends BaseController
{
     ...
     * 查询积分商城商品列表
     */
    @PreAuthorize("@ss.hasPermi('jst:points:mall_goods:list')")
    @GetMapping("/list")
     ...
     * 导出积分商城商品列表
     */
    @PreAuthorize("@ss.hasPermi('jst:points:mall_goods:export')")
     ...
     * 获取积分商城商品详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:points:mall_goods:query')")
     ...
     * 新增积分商城商品
     */
    @PreAuthorize("@ss.hasPermi('jst:points:mall_goods:add')")
     ...
     * 修改积分商城商品
     */
    @PreAuthorize("@ss.hasPermi('jst:points:mall_goods:edit')")
     ...
     * 删除积分商城商品
     */
    @PreAuthorize("@ss.hasPermi('jst:points:mall_goods:remove')")
