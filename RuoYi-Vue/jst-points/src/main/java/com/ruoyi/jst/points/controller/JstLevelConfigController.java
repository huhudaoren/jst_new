 ...
 */
@RestController
@RequestMapping("/jst/points/jst_level_config")
public class JstLevelConfigController extends BaseController
{
     ...
     * 查询等级配置列表
     */
    @PreAuthorize("@ss.hasPermi('jst:points:level_config:list')")
    @GetMapping("/list")
     ...
     * 导出等级配置列表
     */
    @PreAuthorize("@ss.hasPermi('jst:points:level_config:export')")
     ...
     * 获取等级配置详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:points:level_config:query')")
     ...
     * 新增等级配置
     */
    @PreAuthorize("@ss.hasPermi('jst:points:level_config:add')")
     ...
     * 修改等级配置
     */
    @PreAuthorize("@ss.hasPermi('jst:points:level_config:edit')")
     ...
     * 删除等级配置
     */
    @PreAuthorize("@ss.hasPermi('jst:points:level_config:remove')")
