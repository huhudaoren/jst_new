 ...
 */
@RestController
@RequestMapping("/jst/points/jst_points_ledger")
public class JstPointsLedgerController extends BaseController
{
     ...
     * 查询积分流水列表
     */
    @PreAuthorize("@ss.hasPermi('jst:points:points_ledger:list')")
    @GetMapping("/list")
     ...
     * 导出积分流水列表
     */
    @PreAuthorize("@ss.hasPermi('jst:points:points_ledger:export')")
     ...
     * 获取积分流水详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:points:points_ledger:query')")
     ...
     * 新增积分流水
     */
    @PreAuthorize("@ss.hasPermi('jst:points:points_ledger:add')")
     ...
     * 修改积分流水
     */
    @PreAuthorize("@ss.hasPermi('jst:points:points_ledger:edit')")
     ...
     * 删除积分流水
     */
    @PreAuthorize("@ss.hasPermi('jst:points:points_ledger:remove')")
