 ...
 */
@RestController
@RequestMapping("/jst/channel/jst_event_settlement")
public class JstEventSettlementController extends BaseController
{
     ...
     * 导出赛事方结算单列表
     */
    @PreAuthorize("@ss.hasPermi('jst:channel:event_settlement:export')")
     ...
     * 新增赛事方结算单
     */
    @PreAuthorize("@ss.hasPermi('jst:channel:event_settlement:add')")
     ...
     * 删除赛事方结算单
     */
    @PreAuthorize("@ss.hasPermi('jst:channel:event_settlement:remove')")
