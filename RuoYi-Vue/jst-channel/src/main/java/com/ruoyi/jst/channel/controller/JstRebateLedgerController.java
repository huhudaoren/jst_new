 ...
 */
@RestController
@RequestMapping("/jst/channel/jst_rebate_ledger")
public class JstRebateLedgerController extends BaseController
{
     ...
     * 查询返点计提台账列表
     */
    @PreAuthorize("@ss.hasPermi('jst:channel:rebate_ledger:list')")
    @GetMapping("/list")
     ...
     * 导出返点计提台账列表
     */
    @PreAuthorize("@ss.hasPermi('jst:channel:rebate_ledger:export')")
     ...
     * 获取返点计提台账详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:channel:rebate_ledger:query')")
     ...
     * 新增返点计提台账
     */
    @PreAuthorize("@ss.hasPermi('jst:channel:rebate_ledger:add')")
     ...
     * 修改返点计提台账
     */
    @PreAuthorize("@ss.hasPermi('jst:channel:rebate_ledger:edit')")
     ...
     * 删除返点计提台账
     */
    @PreAuthorize("@ss.hasPermi('jst:channel:rebate_ledger:remove')")
