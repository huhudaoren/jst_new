...
import com.ruoyi.jst.message.service.IJstMessageTemplateService;
 ...
 */
@RestController
@RequestMapping("/jst/message/jst_message_template")
public class JstMessageTemplateController extends BaseController
{
     ...
     * 查询消息模板列表
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_template:list')")
    @GetMapping("/list")
     ...
     * 导出消息模板列表
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_template:export')")
     ...
     * 获取消息模板详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_template:query')")
     ...
     * 新增消息模板
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_template:add')")
     ...
     * 修改消息模板
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_template:edit')")
     ...
     * 删除消息模板
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_template:remove')")
