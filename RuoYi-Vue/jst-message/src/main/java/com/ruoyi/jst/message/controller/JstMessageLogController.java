 ...
 */
@RestController
@RequestMapping("/jst/message/jst_message_log")
public class JstMessageLogController extends BaseController
{
     ...
     * 查询消息发送日志列表
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_log:list')")
    @GetMapping("/list")
     ...
     * 导出消息发送日志列表
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_log:export')")
     ...
     * 获取消息发送日志详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_log:query')")
     ...
     * 新增消息发送日志
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_log:add')")
     ...
     * 修改消息发送日志
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_log:edit')")
     ...
     * 删除消息发送日志
     */
    @PreAuthorize("@ss.hasPermi('jst:message:message_log:remove')")
