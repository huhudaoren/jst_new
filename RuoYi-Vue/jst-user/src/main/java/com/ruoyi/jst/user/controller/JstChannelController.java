 ...
 */
@RestController
@RequestMapping("/jst/user/jst_channel")
public class JstChannelController extends BaseController
{
     ...
     * 查询渠道方档案列表
     */
    @PreAuthorize("@ss.hasPermi('jst:user:channel:list')")
    @GetMapping("/list")
     ...
     * 导出渠道方档案列表
     */
    @PreAuthorize("@ss.hasPermi('jst:user:channel:export')")
     ...
     * 获取渠道方档案详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:user:channel:query')")
     ...
     * 新增渠道方档案
     */
    @PreAuthorize("@ss.hasPermi('jst:user:channel:add')")
     ...
     * 修改渠道方档案
     */
    @PreAuthorize("@ss.hasPermi('jst:user:channel:edit')")
     ...
     * 删除渠道方档案
     */
    @PreAuthorize("@ss.hasPermi('jst:user:channel:remove')")
