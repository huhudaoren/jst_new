 ...
 */
@RestController
@RequestMapping("/jst/user/jst_user")
public class JstUserController extends BaseController
{
     ...
     */
    @PreAuthorize("@ss.hasPermi('jst:user:user:list')")
    @GetMapping("/list")
     ...
     */
    @PreAuthorize("@ss.hasPermi('jst:user:user:export')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('jst:user:user:query')")
     ...
     * 新增用户主-学生/家长/渠道方业务账号
     */
    @PreAuthorize("@ss.hasPermi('jst:user:user:add')")
     ...
     * 修改用户主-学生/家长/渠道方业务账号
     */
    @PreAuthorize("@ss.hasPermi('jst:user:user:edit')")
     ...
     * 删除用户主-学生/家长/渠道方业务账号
     */
    @PreAuthorize("@ss.hasPermi('jst:user:user:remove')")
