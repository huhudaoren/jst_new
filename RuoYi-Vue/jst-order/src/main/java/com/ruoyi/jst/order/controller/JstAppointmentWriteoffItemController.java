 ...
 */
@RestController
@RequestMapping("/jst/order/jst_appointment_writeoff_item")
public class JstAppointmentWriteoffItemController extends BaseController
{
     ...
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_writeoff_item:list')")
    @GetMapping("/list")
     ...
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_writeoff_item:export')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_writeoff_item:query')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_writeoff_item:add')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_writeoff_item:edit')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_writeoff_item:remove')")
