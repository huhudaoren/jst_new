...
import com.ruoyi.jst.order.service.IJstRefundRecordService;
 ...
 */
@RestController
@RequestMapping("/jst/order/jst_refund_record")
public class JstRefundRecordController extends BaseController
{
     ...
     * 查询退款/售后单列表
     */
    @PreAuthorize("@ss.hasPermi('jst:order:refund_record:list')")
    @GetMapping("/list")
     ...
     * 导出退款/售后单列表
     */
    @PreAuthorize("@ss.hasPermi('jst:order:refund_record:export')")
     ...
     * 获取退款/售后单详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:order:refund_record:query')")
     ...
     * 新增退款/售后单
     */
    @PreAuthorize("@ss.hasPermi('jst:order:refund_record:add')")
     ...
     * 修改退款/售后单
     */
    @PreAuthorize("@ss.hasPermi('jst:order:refund_record:edit')")
     ...
     * 删除退款/售后单
     */
    @PreAuthorize("@ss.hasPermi('jst:order:refund_record:remove')")
