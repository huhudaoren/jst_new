...
import com.ruoyi.jst.order.service.IJstOrderMainService;
 ...
 */
@RestController
@RequestMapping("/jst/order/jst_order_main")
public class JstOrderMainController extends BaseController
{
     ...
     * 查询订单主列表
     */
    @PreAuthorize("@ss.hasPermi('jst:order:order_main:list')")
    @GetMapping("/list")
     ...
     * 导出订单主列表
     */
    @PreAuthorize("@ss.hasPermi('jst:order:order_main:export')")
     ...
     * 获取订单主详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:order:order_main:query')")
     ...
     * 新增订单主
     */
    @PreAuthorize("@ss.hasPermi('jst:order:order_main:add')")
     ...
     * 修改订单主
     */
    @PreAuthorize("@ss.hasPermi('jst:order:order_main:edit')")
     ...
     * 删除订单主
     */
    @PreAuthorize("@ss.hasPermi('jst:order:order_main:remove')")
