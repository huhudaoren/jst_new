...
import com.ruoyi.jst.order.domain.JstAppointmentRecord;
import com.ruoyi.jst.order.service.IJstAppointmentRecordService;
 ...
 */
@RestController
@RequestMapping("/jst/order/jst_appointment_record")
public class JstAppointmentRecordController extends BaseController
{
     ...
     * 查询个人预约记录列表
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_record:list')")
    @GetMapping("/list")
     ...
     * 导出个人预约记录列表
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_record:export')")
     ...
     * 获取个人预约记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_record:query')")
     ...
     * 新增个人预约记录
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_record:add')")
     ...
     * 修改个人预约记录
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_record:edit')")
     ...
     * 删除个人预约记录
     */
    @PreAuthorize("@ss.hasPermi('jst:order:appointment_record:remove')")
