...
(100, '学生账号',   'jst_student',     10, '1', '1', '1', '0', '0', 'admin', NOW(), '小程序学生/家长默认业务角色'),
...
(103, '平台运营',   'jst_platform_op', 40, '1', '1', '1', '0', '0', 'admin', NOW(), '看全部业务数据');

-- 角色-菜单关联（按 100=student / 101=partner / 102=channel / 103=platform_op 对齐）
INSERT INTO sys_role_menu (role_id, menu_id) VALUES
(100, 2000),(100,2100),(100,2200),(100,2300),(100,2500),(100,2600),
(101, 2000),(101,2200),(101,2300),(101,2900),
(102, 2000),(102,2100),(102,2300),(102,2400),(102,2500),
(103, 2000),(103,2100),(103,2200),(103,2300),(103,2400),(103,2500),(103,2600),(103,2700),(103,2800),(103,2900);

-- =====================================================================
-- 完成。导入完成后请：
-- 1. 在管理后台补齐生成器产出的二级菜单；手写 Controller 权限点执行 95/96/... migration 补齐
